                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col">
                                            <div class="card-body">
                                                ...
                                                <input class="form-control card-title" name="nama" type="hidden" 
                                                    value="<?php echo $row["nma_produk"];?>"
                                                ...
                                                <input class="form-control card-text" type="hidden" name="harga"
                                                    value="<?php echo $row["hrga_produk"];?>"
                                                    aria-label="default input example">
                                                <input class="form-control card-text" type="hidden" name="qty"
                                                    value="<?php echo $row["quantity"];?>"
                                                    aria-label="default input example">

                                                <a href="formedit.php?orderid=<?php echo $row['orderid']; ?>"
                                                    type="submit">
                                                    <span style="color: green;"><i class="fas fa-edit"></i></span>
                                                </a>

                                                <a href="hapus.php?orderid=<?php echo $row['orderid']; ?>" type="submit">
