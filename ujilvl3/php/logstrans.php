...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse text-center navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link active" href="#">Log History</a>
    ...
    <section id="tabel-list">
        ...
        <h3 class="text-center mt-5" style="text-decoration: underline;">Log History Transaksi</h3>
            <div class="card m-4">
                <div class="card-body">
                <table class="text-center table table-success table-striped table-bordered">
                <tr>
                    <th>No.</th>
                    <th>Nama</th>
                    <th>Total Harga</th>
                ...
                <tr>
                    <td><?php echo $no++;?></td>
                    <td><?php echo $row["nma_produk"];?></td>
                    <td>Rp. <?php echo number_format($row["quantity"] * $row["hrga_produk"], 0, ',', '.');?></td>
