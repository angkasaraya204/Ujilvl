                    ...
                    <div class="navbar-nav">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                ...
                                <li><a class="dropdown-item" role="button" type="#" type="submit">Tambah Cart</a></li>
                            </ul>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="submit" class="btn btn-success" name="simpan4" value="simpan">
                        </div>
                        <div class="col-sm">
                            <div class="mb-3">
                            <label class="form-label">Gambar</label>
                            <img src="./img/Cara-Memperbaiki-Foto-yang-Rusak-removebg-preview.png" style="width: 40%;" alt="">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="qty" placeholder="Masukan Quantity">
                            </div>
                        </div>
                    </div>
                </form>
